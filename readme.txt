...
create a directory in your theme ( or child theme ) directory called widget-for-eventbrite-api  and copy the template(s) from wp-content/plugins/widget-for-eventbrite-api/templates__free/  and modify as required.
